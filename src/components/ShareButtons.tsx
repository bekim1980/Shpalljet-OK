...
const ShareButtons = ({ title, productId }: ShareButtonsProps) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={() => window.open(`https://wa.me/?text=${text}%20${encodedUrl}`, "_blank", "noopener")}
      ...
      <button
        onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`, "_blank", "noopener,width=600,height=400")}
